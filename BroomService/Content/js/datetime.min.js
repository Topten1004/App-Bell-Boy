    ...
    function(a) {
        ...
        glyphicons: {
            icons: {
                ...
                previousMonth: '<span class="fa fa-angle-left"></span>',
                nextMonth: '<span class="fa fa-angle-right"></span>'
            }
        }
    ...
    function(a) {
        ...
        createPicker: function(a) {
            var b, c = a.data(),
                ...
                h = $('<div role="mode" />'),
                i = $('<div role="body" />'),
                j = $('<button class="colored ' + c.style.button + '">' + gj.core.messages[c.locale].ok + "</button>"),
